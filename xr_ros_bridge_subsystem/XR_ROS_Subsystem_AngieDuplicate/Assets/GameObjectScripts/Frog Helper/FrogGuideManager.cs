...
public class FrogGuideManager : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        if (!guideOpen || !guidePanel.activeSelf) return;
    ...
    void Start()
    {
        ...
        Canvas canvas = guidePanel.GetComponentInParent<Canvas>();
    ...
    void OpenHelpMenu()
    {
        ...
        ShowSingleLine("Ribbit! Which puzzle do you need help with?",
            frogPointing);
    }
    ...
    public void CloseGuide()
    {
        ...
        // Disable canvas for performance
        Canvas canvas = guidePanel.GetComponentInParent<Canvas>();
        if (canvas != null) canvas.enabled = false;
