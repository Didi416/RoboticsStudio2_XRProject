...
public class PuzzleGUIScript : MonoBehaviour
{
    ...
    [Header("Buttons")]
    public Button closeButton;
    public Button resetRobotButton;      // hover/reset
    public Button facePuzzleBoardButton; // face puzzle board
    public Button faceEggsButton;        // face egg puzzle
    public Button resetPuzzleButton;
    ...
    void Start()
    {
        ...
        if (resetRobotButton != null)
            resetRobotButton.onClick.AddListener(OnResetRobotPressed);
        if (facePuzzleBoardButton != null)
            facePuzzleBoardButton.onClick.AddListener(OnFacePuzzleBoardPressed);
        if (faceEggsButton != null)
            faceEggsButton.onClick.AddListener(OnFaceEggsPressed);
        if (resetPuzzleButton != null)
            resetPuzzleButton.onClick.AddListener(OnResetPuzzlePressed);
        if (dismissWarningButton != null)
            dismissWarningButton.onClick.AddListener(OnDismissWarning);
